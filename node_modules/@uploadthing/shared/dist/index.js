...
// src/utils.ts
var import_mime_types = require("@uploadthing/mime-types");
var import_meta = {};
...
function generateUploadThingURL(path) {
  ...
  if (typeof process !== "undefined") {
    ...
    host = ((_a = import_meta.env) == null ? void 0 : _a.CUSTOM_INFRA_URL) ?? host;
  }
  return `${host}${path}`;
}
