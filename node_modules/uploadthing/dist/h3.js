...
var createH3EventHandler = (opts) => {
  ...
  return (0, import_h3.defineEventHandler)(async (event) => {
    var _a;
    (0, import_h3.assertMethod)(event, ["GET", "POST"]);
    (0, import_h3.setHeaders)(event, { "x-uploadthing-version": UPLOADTHING_VERSION });
    if (event.method === "GET") {
      return getBuildPerms();
    }
    const response = await requestHandler({
      req: {
        url: (0, import_h3.getRequestURL)(event).href,
        headers: (0, import_h3.getRequestHeaders)(event),
        json: () => Promise.resolve((0, import_h3.readBody)(event))
      },
      event
    });
    if (response instanceof import_shared3.UploadThingError) {
      (0, import_h3.setResponseStatus)(event, (0, import_shared3.getStatusCodeFromError)(response));
