...
import {
  ...
  useDropzone
} from "./chunk-THQLD3GT.js";
import {
  require_jsx_runtime
} from "./chunk-2ZZPWDJ7.js";
import {
  __toESM,
  require_react
...
function UploadButton(props) {
  ...
  const [uploadProgressState, setUploadProgress] = (0, import_react.useState)(
    $props.__internal_upload_progress ?? 0
  );
  const [files, setFiles] = (0, import_react.useState)([]);
  const [isManualTriggerDisplayed, setIsManualTriggerDisplayed] = (0, import_react.useState)(false);
      ...
      children: [
        (0, import_jsx_runtime2.jsxs)(
          "label",
          {
            ...
            children: [
              (0, import_jsx_runtime2.jsx)("input", { ...getInputProps(), className: "sr-only" }),
              contentFieldToContent((_e = $props.content) == null ? void 0 : _e.button, styleFieldArg) ?? getUploadButtonContents(fileTypes)
            ]
          }
        ),
...
function UploadDropzone(props) {
  ...
  const [uploadProgressState, setUploadProgress] = (0, import_react2.useState)(
    $props.__internal_upload_progress ?? 0
  );
  const uploadProgress = $props.__internal_upload_progress ?? uploadProgressState;
  const { startUpload, isUploading, permittedFileInfo } = useUploadThing(
  ...
  return (0, import_jsx_runtime3.jsxs)(
    "div",
    {
      ...
      "data-state": state,
      children: [
        contentFieldToContent((_c = $props.content) == null ? void 0 : _c.uploadIcon, styleFieldArg) ?? (0, import_jsx_runtime3.jsx)(
          "svg",
          {
            xmlns: "http://www.w3.org/2000/svg",
            viewBox: "0 0 20 20",
        ...
        (0, import_jsx_runtime3.jsxs)(
          "label",
          {
            ...
            children: [
              ...
              (0, import_jsx_runtime3.jsx)("input", { className: "sr-only", ...getInputProps() })
            ]
          }
        ),
        ...
        ($props.__internal_show_button ?? files.length > 0) && (0, import_jsx_runtime3.jsx)(
          "button",
          {
            className: twMerge(
              classNames(
            ...
            children: contentFieldToContent((_n = $props.content) == null ? void 0 : _n.button, styleFieldArg) ?? (state === "uploading" ? (0, import_jsx_runtime3.jsx)(Spinner, {}) : `Upload ${files.length} file${files.length === 1 ? "" : "s"}`)
          }
        )
      ]
    }
...
function Uploader(props) {
  return (0, import_jsx_runtime4.jsxs)(import_jsx_runtime4.Fragment, { children: [
    (0, import_jsx_runtime4.jsxs)("div", { className: "flex flex-col items-center justify-center gap-4", children: [
      (0, import_jsx_runtime4.jsx)("span", { className: "text-center text-4xl font-bold", children: `Upload a file using a button:` }),
      (0, import_jsx_runtime4.jsx)(UploadButton, { ...props })
    ] }),
    (0, import_jsx_runtime4.jsxs)("div", { className: "flex flex-col items-center justify-center gap-4", children: [
      (0, import_jsx_runtime4.jsx)("span", { className: "text-center text-4xl font-bold", children: `...or using a dropzone:` }),
      (0, import_jsx_runtime4.jsx)(UploadDropzone, { ...props })
    ] })
  ] });
}
function generateComponents(initOpts) {
  ...
  return {
    UploadButton: (props) => (0, import_jsx_runtime4.jsx)(UploadButton, { ...props, url }),
    UploadDropzone: (props) => (0, import_jsx_runtime4.jsx)(UploadDropzone, { ...props, url }),
    Uploader: (props) => (0, import_jsx_runtime4.jsx)(Uploader, { ...props, url })
  };
}
export {
  UploadButton,
...
//# sourceMappingURL=@uploadthing_react.js.map
